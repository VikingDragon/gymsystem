...
class VentaController extends Controller
{
    ...
    public function actionVenta()
    {
        ...
        $venta->estado = 2;
        $venta->empleado_idempleado =  Yii::$app->user->identity->empleado->idempleado;
        ...
        try {
            if ($detalleVenta->load(Yii::$app->request->post())) {
                if ($venta->load(Yii::$app->request->post()) && $venta->save()) {
                    $detalleVenta->venta_idventa = $venta->idventa;
                    $detalleVenta->costo = 0;
